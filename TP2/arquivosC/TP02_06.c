...
int main() {
    ...
    Show** shows = (Show **) malloc(numLinhas * sizeof(Show*));
    for (int i = 0; i < numLinhas; i++) {
        shows[i] = (Show *) malloc(sizeof(Show));
    ...
    // Ordenar shows pelo título
    qsort(showsSelecionados, numSelecionados, sizeof(Show*), compareShows);
