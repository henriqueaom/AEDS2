...
public class TP02_13 {
    ...
    public static void main(String[] args) {
        ...
        // Lê os IDs de entrada do usuário
        ...
        // Ordena os shows selecionados pela duração original (como string)
        showsSelecionados.sort(Comparator.comparing(Show::getDuration)
