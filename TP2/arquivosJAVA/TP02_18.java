...
import java.util.*;
 ...
 class TP02_18 {
    ...
    public static class Show {
        ...
        private Date dataAdded;  // Campo usado para ordenação
        ...
        public void ler(String linha) {
            ...
            try {
                String data = getOrNaN(campos, 6);  // Campo data_add está na posição 6
    ...
    public static void main(String[] args) {
        ...
        // Ordena por data de adição (mais antiga primeiro) e depois por título como critério de desempate
        showsSelecionados.sort(Comparator.comparing(Show::getDataAdded)
                                      .thenComparing(Show::getTitle));

        // Imprime apenas os 10 primeiros resultados
        int limite = Math.min(10, showsSelecionados.size());
        for (int i = 0; i < limite; i++) {
            System.out.println(showsSelecionados.get(i).formatar());
        }
